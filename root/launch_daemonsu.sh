...
# THIS FILE IS MODIFIED FROM THE ORIGINAL SUPERSU v2.74-2 DISTRIBUTION
#
# - rootfs is remount r/w and /su created
# - "supolicy --live" is called before launching the daemon
#
# Changes are marked with #S7QC
